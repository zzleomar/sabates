$(function() {
    ...
    var uiElements = function(){
        ...
        var uiDatatable = function(){
            ...
            console.log($(".datatable_simple").length);
            if($(".datatable").length > 0){
                console.log('1');            
                $(".datatable").dataTable({"language": {"paginate": {"next":"Siguiente","previous":"Anterior"},"info":"Mostrando 0 a 0 de 0 registros","lengthMenu":"Mostrar _MENU_ registros","search": "Buscar:"}});
            ...
            if($(".datatable_simple").length > 0){
                console.log('2');                
                $(".datatable_simple").dataTable({"language": {"search": "Buscar 2222:"},"ordering": false, "info": false, "lengthChange": false,"searching": false});
